...
class Socket(Serializable):
    ...
    def removeEdge(self, edge):
        ...
        else: print("!W:", "Socket::removeEdge", "wanna remove edge", edge,
    ...
    def determineMultiEdges(self, data):
        if 'multi_edges' in data:
            ...
            # probably older version of file, make RIGHT socket multi_edge by default
    ...
    def serialize(self):
        return OrderedDict([
            ('id', self.id),
            ('index', self.index),
            ('multi_edge', self.is_multi_edges),
