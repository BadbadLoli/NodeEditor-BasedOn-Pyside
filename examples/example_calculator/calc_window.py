...
class CalculatorWindow(NodeEditorWindow):
    ...
    def about(self):
        QMessageBox.about(self, "About Calculator NodeEditor Example",
                ...
                "document interface applications using Pyside2 and NodeEditor. For more information visit: "
                "<a href='https://www.sample.com/'>www.LRChong.com</a>")
